...
/**
 * Vpis z Registru crkv a nboenskch spolenost v ARES 1.0.1
 * 
...
public class VypisRcns {
    ...
    protected Uvod uvod;
    @XmlElement(name = "RCNS", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
