...
public class KChyba {
    ...
    @XmlElement(name = "Cislo_chyby", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected int cisloChyby;
    @XmlElement(name = "Nazev_chyby", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
    protected String nazevChyby;
    @XmlElement(name = "Popis_chyby", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
    protected String popisChyby;
    @XmlElement(name = "Zavaznost", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
