...
public class Uvod {
    ...
    @XmlElement(name = "Nadpis", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected String nadpis;
    @XmlElement(name = "Aktualizace_DB", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar aktualizaceDB;
    @XmlElement(name = "Datum_vypisu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar datumVypisu;
    @XmlElement(name = "Cas_vypisu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    @XmlSchemaType(name = "time")
    protected XMLGregorianCalendar casVypisu;
    @XmlElement(name = "Typ_vypisu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected String typVypisu;
    @XmlElement(name = "Pozadovane_datum_platnosti_dat", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar pozadovaneDatumPlatnostiDat;
    @XmlElement(name = "Typ_odkazu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected String typOdkazu;
    @XmlElement(name = "Typ_odpovedi", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
