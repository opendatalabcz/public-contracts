...
/**
 * Kombinovan angam - kombinace daj  PO a FO, vetn vkladu spolenka (v id je slovo vklad)
 * 
...
public class Angazma {
    ...
    @XmlElement(name = "Kod_angm", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Short kodAngm;
    @XmlElement(name = "Funkce", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected String funkce;
    @XmlElement(name = "Oznaceni", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected String oznaceni;
    @XmlElement(name = "Pravnicka_osoba", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected PravnickaOsoba pravnickaOsoba;
    @XmlElement(name = "Fyzicka_osoba", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected FyzickaOsoba fyzickaOsoba;
    @XmlElement(name = "Clenstvi", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Trvani clenstvi;
    @XmlElement(name = "Ve_funkci", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Trvani veFunkci;
    @XmlElement(name = "Vklad_spolecnika", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
