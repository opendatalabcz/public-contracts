...
/**
 * daje o nstupcch zizovatele OZ (od jna 2003)
 * 
...
public class NastupciZrizovatele {
    ...
    @XmlElement(name = "Nastupce_zrizovatele", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
