...
/**
 * Ope dol dotaz, pp. dopln implicitn hodnoty msto nezadanch a pid k nmu nalezenou odpov
 * 
...
public class StadrsDotaz {
    ...
    @XmlElement(name = "Kod_statu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    ...
    @XmlElement(name = "Cislo_do_adresy", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    ...
    @XmlElement(name = "Adresa_textem", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected String adresaTextem;
    @XmlElement(name = "Diakritika", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", defaultValue = "true")
    protected boolean diakritika;
    @XmlElement(name = "Kod_diakritiky", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true, defaultValue = "ISO")
    @XmlSchemaType(name = "string")
    protected KodDiakritiky kodDiakritiky;
    @XmlElement(name = "Max_pocet", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", defaultValue = "20")
    protected short maxPocet;
    @XmlElement(name = "Preteceni", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true, defaultValue = "N")
    @XmlSchemaType(name = "string")
    protected Preteceni preteceni;
    @XmlElement(name = "Redukce_slov", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true, defaultValue = "A")
    protected String redukceSlov;
    @XmlElement(name = "Format_odpovedi", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true, defaultValue = "XML")
    @XmlSchemaType(name = "string")
    protected VystupFormat formatOdpovedi;
    @XmlElement(name = "Chyba", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
