...
/**
 * daje o zizovateli pspvkov organizace
 * 
...
public class ZrizovatelePR {
    ...
    @XmlElement(name = "Zrizovatel_PR", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
