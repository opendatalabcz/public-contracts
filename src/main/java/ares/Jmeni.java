...
/**
 * Jmeni z Kapitlu, nov v 1.0.2 (dtt:Text znovu od 26.1.2010)
 * 
...
public class Jmeni {
    ...
    @XmlElement(name = "Podilnik", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<Angazma> podilnik;
    @XmlElement(name = "Vklad", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<Vklad> vklad;
    @XmlElement(name = "Splaceno", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<Splaceno> splaceno;
    @XmlElement(name = "Text_ke_spolecnemu_podilu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<Texty> textKeSpolecnemuPodilu;
    @XmlElement(name = "Zastavni_pravo", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<Texty> zastavniPravo;
    @XmlElement(name = "Obchodni_podil", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<Texty> obchodniPodil;
    @XmlElement(name = "Komentar", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<Texty> komentar;
    @XmlElement(name = "Text_k_uvolnenemu_podilu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
