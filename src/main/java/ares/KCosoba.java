...
/**
 * Osoby ve smyslu civilnch individu
 * 
...
public class KCosoba {
    ...
    @XmlElement(name = "Podnika", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
    ...
    @XmlElement(name = "Rodne_cislo", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
    protected String rodneCislo;
    @XmlElement(name = "Rozliseni_rodneho_cisla", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
