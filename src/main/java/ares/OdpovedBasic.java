...
public class OdpovedBasic {
    ...
    @XmlElement(name = "Pomocne_ID", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected int pomocneID;
    @XmlElement(name = "Error", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected ErrorARES error;
    @XmlElement(name = "Vysledek_hledani", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
    protected VysledekHledani vysledekHledani;
    @XmlElement(name = "Pocet_zaznamu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    ...
    protected Uvod uvod;
    @XmlElement(name = "Vypis_basic", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
