...
/**
 * daje o zakladatelch obecn prospn spolenosti
 * 
...
public class ZakladateleOPS {
    ...
    @XmlElement(name = "Zakladatel_OPS", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
