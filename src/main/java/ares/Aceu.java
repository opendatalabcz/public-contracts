...
/**
 * Data upraven dle ARES (tabulka k_podnet)
 * 
...
public class Aceu {
    ...
    @XmlElement(name = "K_konkurz", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
    ...
    @XmlElement(name = "Datum_vzniku_podnetu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar datumVznikuPodnetu;
    @XmlElement(name = "Kod_ukonu_podnetu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected byte kodUkonuPodnetu;
    @XmlElement(name = "Priznak_usneseni", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
    protected String priznakUsneseni;
    @XmlElement(name = "Radky_textu_usneseni", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected RadkyTextuUsneseni radkyTextuUsneseni;
    @XmlElement(name = "Jmeno_souboru_s_usnesenim", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected String jmenoSouboruSUsnesenim;
    @XmlElement(name = "Spravce_konkurzu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<SpravceKonkurzuCEU> spravceKonkurzu;
    @XmlElement(name = "Priznaky", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
