...
/**
 * Sekce daj o konkurzech, vyrovnnch a zamtnutch konkurz
 * 
...
public class KonkurzyVyrovnani {
    ...
    @XmlElement(name = "Ukon", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
