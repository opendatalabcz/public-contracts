...
public class Udalost {
    ...
    @XmlElement(name = "Typ_datumu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected String typDatumu;
    @XmlElement(name = "Typ_zmeny", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected TypZmeny typZmeny;
    @XmlElement(name = "Usneseni", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Boolean usneseni;
    @XmlElement(name = "ID_usneseni", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected BigInteger idUsneseni;
    @XmlElement(name = "Stav", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Stav stav;
