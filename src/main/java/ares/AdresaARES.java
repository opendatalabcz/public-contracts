...
/**
 * Definice elementu nvratov adresy ARES
 * 
...
public class AdresaARES {
    ...
    @XmlElement(name = "ID_adresy", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    ...
    @XmlElement(name = "Zahr_PSC", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    ...
    @XmlElement(name = "Adresa_UIR", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
