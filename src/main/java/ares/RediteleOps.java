...
/**
 * editel obecn prospn spolenosti se me vyskytovat pouze jako fyzick osoba
 * 
...
public class RediteleOps {
    ...
    @XmlElement(name = "Reditel_ops", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
