...
public class Konkurz {
    ...
    @XmlElement(name = "Udaje_KVZ", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
    protected UdajeKVZ udajeKVZ;
    @XmlElement(name = "Spravci_KP", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Spravce spravciKP;
    @XmlElement(name = "Zastupci_spravce", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Spravce zastupciSpravce;
    @XmlElement(name = "Zvlastni_spravci", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Spravce zvlastniSpravci;
    @XmlElement(name = "Predbezni_spravci", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
