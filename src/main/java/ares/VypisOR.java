...
/**
 * Vpis z obchodnho rejstku podle ARES
 * 
...
public class VypisOR {
    ...
    @XmlElement(name = "Uvod", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Uvod uvod;
    @XmlElement(name = "Zakladni_udaje", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
    protected ZakladniUdajeOR zakladniUdaje;
    @XmlElement(name = "Registrace", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
    ...
    @XmlElement(name = "Exekuce", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<Texty> exekuce;
    @XmlElement(name = "Ostatni_skutecnosti", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<Texty> ostatniSkutecnosti;
    @XmlElement(name = "Kapital", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Kapital kapital;
    @XmlElement(name = "Statutarni_organ", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected StatutarniOrgan statutarniOrgan;
    @XmlElement(name = "Statutarni_organ_spolecnosti", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Sos statutarniOrganSpolecnosti;
    @XmlElement(name = "Statutarni_organ_komplementaru", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Sok statutarniOrganKomplementaru;
    @XmlElement(name = "Statutarni_organ_predstavenstvo", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Sop statutarniOrganPredstavenstvo;
    @XmlElement(name = "Predstavenstvo", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Predstavenstvo predstavenstvo;
    @XmlElement(name = "Statutarni_organ_zrizovatele_ZO", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Szo statutarniOrganZrizovateleZO;
    @XmlElement(name = "Spravni_rada", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected SpravniRada spravniRada;
    @XmlElement(name = "Nadace", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Nadace nadace;
    @XmlElement(name = "Nadacni_fond", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected NadacniFond nadacniFond;
    @XmlElement(name = "Likvidace", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Likvidace likvidace;
    @XmlElement(name = "Prokura", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Prokura prokura;
    @XmlElement(name = "Reditele_ops", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected RediteleOps rediteleOps;
    @XmlElement(name = "Dozorci_rada", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected DozorciRada dozorciRada;
    @XmlElement(name = "Kontrolni_komise", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected KontrolniKomise kontrolniKomise;
    @XmlElement(name = "Revizori", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Revizori revizori;
    @XmlElement(name = "Spolecnici_bez_vkladu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected SpolecniciBezVkladu spolecniciBezVkladu;
    @XmlElement(name = "Spolecnici_s_vkladem", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected SpolecniciSVkladem spolecniciSVkladem;
    @XmlElement(name = "Akcionari", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Akcionari akcionari;
    @XmlElement(name = "Zakladatele_SP", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected ZakladateleSP zakladateleSP;
    @XmlElement(name = "Zakladatele_OPS", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected ZakladateleOPS zakladateleOPS;
    @XmlElement(name = "Zrizovatele_OZ", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected ZrizovateleOZ zrizovateleOZ;
    @XmlElement(name = "Zrizovatele_PR", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected ZrizovatelePR zrizovatelePR;
    @XmlElement(name = "Nastupci_zrizovatelu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected NastupciZrizovatele nastupciZrizovatelu;
    @XmlElement(name = "Zrizovatele_nadace", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected ZrizovateleNadace zrizovateleNadace;
    @XmlElement(name = "Vedouci_odstepnych_zavodu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected VedOz vedouciOdstepnychZavodu;
    @XmlElement(name = "Komanditiste", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Komanditiste komanditiste;
    @XmlElement(name = "Druzstevnici", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Druzstevnici druzstevnici;
    @XmlElement(name = "Komplementari", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Komplementari komplementari;
    @XmlElement(name = "Clenove_sdruzeni", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected ClenoveSdruzeni clenoveSdruzeni;
    @XmlElement(name = "Konkurzy_vyrovnani", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected KonkurzyVyrovnani konkurzyVyrovnani;
    @XmlElement(name = "Odstepne_zavody", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
