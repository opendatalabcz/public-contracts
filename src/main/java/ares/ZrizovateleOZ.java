...
/**
 * daje o zizovateli odtpnho zvodu
 * 
...
public class ZrizovateleOZ {
    ...
    @XmlElement(name = "Zrizovatel_OZ", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
