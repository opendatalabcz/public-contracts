...
public class ObecRFO {
    ...
    @XmlElement(name = "Kod_obce", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
    protected String kodObce;
    @XmlElement(name = "Nazev", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
    protected String nazev;
    @XmlElement(name = "Prazsky_obvod", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<PrazskyObvodRFO> prazskyObvod;
    @XmlElement(name = "Mestska_cast", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<MestskaCastRFO> mestskaCast;
    @XmlElement(name = "Cast_obce", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
