...
/**
 * Standardizace adres pro rejstkov soudy ope dol dotaz a pid k nmu nalezenou odpov
 * 
...
public class Stadrs {
    ...
    @XmlElement(name = "Stadrs_dotaz", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
    protected StadrsDotaz stadrsDotaz;
    @XmlElement(name = "Stadrs_odpoved", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
