...
public class DalsiUdaje {
    ...
    @XmlElement(name = "Druh_zarizeni_kod", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    ...
    @XmlElement(name = "Typ_ucetnictvi_kod", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Short typUcetnictviKod;
    @XmlElement(name = "Typ_ucetnictvi", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
