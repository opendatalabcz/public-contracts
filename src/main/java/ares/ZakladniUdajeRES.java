...
public class ZakladniUdajeRES {
    ...
    @XmlElement(name = "Zpusob_vzniku", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Short zpusobVzniku;
    @XmlElement(name = "Zpusob_zaniku", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
