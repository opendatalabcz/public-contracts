...
/**
 * daje o oborech innosti u ivnosti i provozovny
 * 
...
public class OboryCinnosti {
    ...
    @XmlElement(name = "Obor_cinnosti", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
