...
/**
 * Informace o splacen stky vkladu v K, procentech nebo slovy volnm textem
 * 
...
public class Splaceno {
    ...
    @XmlElement(name = "Kc", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected String kc;
    @XmlElement(name = "Procenta", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected String procenta;
    @XmlElement(name = "Ostatni", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
