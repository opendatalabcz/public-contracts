...
public class AdresaUIR {
    ...
    @XmlElement(name = "Kod_oblasti", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.1")
    protected String kodOblasti;
    @XmlElement(name = "Kod_kraje", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.1")
    protected String kodKraje;
    @XmlElement(name = "Kod_okresu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.1")
    @XmlSchemaType(name = "integer")
    protected Integer kodOkresu;
    @XmlElement(name = "Kod_obce", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.1")
    protected String kodObce;
    @XmlElement(name = "Kod_pobvod", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.1")
    protected String kodPobvod;
    @XmlElement(name = "Kod_sobvod", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.1")
    protected String kodSobvod;
    @XmlElement(name = "Kod_nobvod", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.1")
    protected String kodNobvod;
    @XmlElement(name = "Kod_casti_obce", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.1")
    protected String kodCastiObce;
    @XmlElement(name = "Kod_mestske_casti", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.1")
    protected String kodMestskeCasti;
    @XmlElement(name = "PSC", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.1")
    protected String psc;
    @XmlElement(name = "Kod_ulice", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.1")
    protected String kodUlice;
    @XmlElement(name = "Cislo_domovni", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.1")
    protected Integer cisloDomovni;
    @XmlElement(name = "Typ_cislo_domovni", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.1")
    protected Byte typCisloDomovni;
    @XmlElement(name = "Cislo_orientacni", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.1")
    protected String cisloOrientacni;
    @XmlElement(name = "Pism_cislo_orientacni", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.1")
    protected String pismCisloOrientacni;
    @XmlElement(name = "Kod_adresy", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.1")
    protected String kodAdresy;
    @XmlElement(name = "Kod_objektu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.1")
    protected String kodObjektu;
    @XmlElement(name = "PCD", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.1")
