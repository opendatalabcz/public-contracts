...
/**
 * Hlavn tabulka padc - slou zejmna pro rozlien, o jakho padce se jedn
 * 
...
public class KUpadce {
    ...
    @XmlElement(name = "S_upadce", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected int sUpadce;
    @XmlElement(name = "PFC", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
    @XmlSchemaType(name = "string")
    protected Pfc pfc;
    @XmlElement(name = "K_eksubj", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
