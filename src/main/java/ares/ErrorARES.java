...
/**
 * Definice elementu obecn chyby dotazu v ARES
 * 
...
public class ErrorARES {
    ...
    @XmlElement(name = "Error_kod", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected byte errorKod;
    @XmlElement(name = "Error_text", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
