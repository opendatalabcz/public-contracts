...
/**
 * Zkladn daje o ekonomickm subjektu resp. fyzick osob z CEU, vyitn, upraven.
 * 
...
public class KEksubj {
    ...
    protected Pfc pfo;
    @XmlElement(name = "Cele_jmeno", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
    ...
    @XmlElement(name = "Adresa_sidla", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected AdresaARES adresaSidla;
    @XmlElement(name = "K_cosoba", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected KCosoba kCosoba;
    @XmlElement(name = "Ares", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
