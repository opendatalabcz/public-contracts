...
/**
 * Spisov znaka, pod kterou je veden spis subjektu u danho soudu. (Bv zapisovna oddl / vloka.)
 * 
...
public class SpisovaZnacka {
    ...
    @XmlElement(name = "Soud", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
    protected Soud soud;
    @XmlElement(name = "Oddil_vlozka", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
