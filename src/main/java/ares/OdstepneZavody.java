...
public class OdstepneZavody {
    ...
    @XmlElement(name = "Odstepny_zavod", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
    protected List<OdstepnyZavod> odstepnyZavod;
     ...
     *
     */
    public List<OdstepnyZavod> getOdstepnyZavod() {
        if (odstepnyZavod == null) {
            odstepnyZavod = new ArrayList<OdstepnyZavod>();
        }
