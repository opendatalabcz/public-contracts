...
public class AdresaUIRSNazvy {
    ...
    @XmlElement(name = "Kod_kraje", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Short kodKraje;
    @XmlElement(name = "Nazev_kraje", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected String nazevKraje;
    @XmlElement(name = "CZNUTS", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected String cznuts;
    @XmlElement(name = "Kod_okresu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    @XmlSchemaType(name = "integer")
    protected Integer kodOkresu;
    @XmlElement(name = "Nazev_okresu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected String nazevOkresu;
    @XmlElement(name = "Kod_obce", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected String kodObce;
    @XmlElement(name = "Nazev_obce", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected String nazevObce;
    @XmlElement(name = "Kod_prazskeho_obvodu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Integer kodPrazskehoObvodu;
    @XmlElement(name = "Nazev_prazskeho_obvodu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected String nazevPrazskehoObvodu;
    @XmlElement(name = "Kod_mestske_casti", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected String kodMestskeCasti;
    @XmlElement(name = "Nazev_mestske_casti", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected String nazevMestskeCasti;
    @XmlElement(name = "Kod_casti_obce", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected String kodCastiObce;
    @XmlElement(name = "Nazev_casti_obce", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected String nazevCastiObce;
    @XmlElement(name = "Kod_ulice", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected String kodUlice;
    @XmlElement(name = "Nazev_ulice", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected String nazevUlice;
    @XmlElement(name = "Cislo_domovni", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Integer cisloDomovni;
    @XmlElement(name = "Typ_cislo_domovni", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Byte typCisloDomovni;
    @XmlElement(name = "Cislo_orientacni", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected String cisloOrientacni;
    @XmlElement(name = "Pism_cislo_orientacni", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected String pismCisloOrientacni;
    @XmlElement(name = "PSC", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected String psc;
    @XmlElement(name = "Kod_objektu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected String kodObjektu;
    @XmlElement(name = "Kod_adresy", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
