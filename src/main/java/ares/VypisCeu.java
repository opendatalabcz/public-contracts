...
/**
 * Vpis informac o padci z Centrln evidence padc dle ARES
 * 
...
public class VypisCeu {
    ...
    @XmlElement(name = "Uvod", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
    protected Uvod uvod;
    @XmlElement(name = "Subjekt", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
