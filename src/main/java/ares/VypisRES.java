...
/**
 * Vpis z registru ekonomickch subjekt eskho statistickho adu
 * 
...
public class VypisRES {
    ...
    @XmlElement(name = "ZUJ", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Zuj zuj;
    @XmlElement(name = "Statisticke_udaje", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
