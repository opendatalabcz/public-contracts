...
/**
 * Vpis z rejstku ivnostenskho podnikn v ARES
 * 
...
public class VypisRZP {
    ...
    @XmlElement(name = "Registrace", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected RegistraceRZP registrace;
    @XmlElement(name = "Pocet_zivnosti", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected BigInteger pocetZivnosti;
    @XmlElement(name = "Zivnosti", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
