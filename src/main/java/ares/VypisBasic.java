...
public class VypisBasic {
    ...
    @XmlElement(name = "ICO", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
    protected Ico ico;
    @XmlElement(name = "DIC", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Dic dic;
    @XmlElement(name = "Obchodni_firma", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
    ...
    @XmlElement(name = "Pravni_forma", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected PravniForma pravniForma;
    @XmlElement(name = "Doplnujici_PF", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected DoplnujiciPravniFormy doplnujiciPF;
    @XmlElement(name = "Adresa_dorucovaci", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected AdresaDorucovaci adresaDorucovaci;
    @XmlElement(name = "Adresa_ARES", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected AdresaARES adresaARES;
    @XmlElement(name = "Adr_puv", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected AdresaARES adrPuv;
    @XmlElement(name = "Priznaky_subjektu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected String priznakySubjektu;
    @XmlElement(name = "Registrace_OR", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<Registrace> registraceOR;
    @XmlElement(name = "Registrace_RZP", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<RegistraceRZP> registraceRZP;
    @XmlElement(name = "Stav_subjektu_CEU", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected StavSubjektuCeu stavSubjektuCEU;
    @XmlElement(name = "Kategorie_poctu_pracovniku", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected KategoriePoctuPracovniku kategoriePoctuPracovniku;
    @XmlElement(name = "OKECE", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<Okec> okece;
    @XmlElement(name = "Nace", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<Nace> nace;
    @XmlElement(name = "Predmety_podnikani", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected PredmetyPodnikani predmetyPodnikani;
    @XmlElement(name = "Obory_cinnosti", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
