...
/**
 * len kontroln komise u prvn formy 932 (od 8/2006)
 * 
...
public class KontrolniKomise {
    ...
    @XmlElement(name = "Clen_kontrolni_komise", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
