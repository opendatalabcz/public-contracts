...
public class RegistraceRZP {
    ...
    @XmlElement(name = "Zivnostensky_urad", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected ZivnostenskyUrad zivnostenskyUrad;
    @XmlElement(name = "V_jednani", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected String vJednani;
    @XmlElement(name = "Obchodni_rejstrik", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
