...
/**
 * Data dodan z Ministerstva spravedlnosti
 * 
...
public class Msp {
    ...
    @XmlElement(name = "Vk_podnet", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
    protected VkPodnet vkPodnet;
    @XmlElement(name = "Vk_adresa", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
