...
/**
 * Stav subjektu: Aktivn / Zanikl a atributy Konkurz, Vyrovnani, Zamitnuti, Likvidace
 * 
...
public class Stav {
    ...
    @XmlElement(name = "Stav_subjektu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    @XmlSchemaType(name = "string")
    protected StavSubjektu stavSubjektu;
    @XmlElement(name = "Konkurz", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
    protected StavKVZ konkurz;
    @XmlElement(name = "Vyrovnani", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
    protected StavKVZ vyrovnani;
    @XmlElement(name = "Zamitnuti", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
    protected StavKVZ zamitnuti;
    @XmlElement(name = "Likvidace", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
