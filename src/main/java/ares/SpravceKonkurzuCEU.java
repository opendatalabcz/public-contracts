...
public class SpravceKonkurzuCEU {
    ...
    @XmlElement(name = "Cele_jmeno_spravce", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
    protected String celeJmenoSpravce;
    @XmlElement(name = "Adresa_spravce", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected AdresaARES adresaSpravce;
    @XmlElement(name = "Bydliste_spravce", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
