...
public class AdresaDorucovaci {
    ...
    @XmlElement(name = "Ulice_cislo", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected String uliceCislo;
    @XmlElement(name = "PSC_obec", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
