...
/**
 * informace o zkladnm jmn subjektu
 * 
...
public class Kapital {
    ...
    @XmlElement(name = "Zakladni", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<VkladSpolecnika> zakladni;
    @XmlElement(name = "Upsany", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<VkladSpolecnika> upsany;
    @XmlElement(name = "Kmenove_jmeni", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<Jmeni> kmenoveJmeni;
    @XmlElement(name = "Nadacni_jmeni", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<Jmeni> nadacniJmeni;
    @XmlElement(name = "Zapisovany", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<VkladSpolecnika> zapisovany;
    @XmlElement(name = "Minimalni_kmenove_jmeni", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<Jmeni> minimalniKmenoveJmeni;
    @XmlElement(name = "Majetkovy_vklad", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<Jmeni> majetkovyVklad;
    @XmlElement(name = "Zakladni_vklad", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<Jmeni> zakladniVklad;
    @XmlElement(name = "Clensky_vklad", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<Jmeni> clenskyVklad;
    @XmlElement(name = "Spolecny_podil", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<Jmeni> spolecnyPodil;
    @XmlElement(name = "Uvolneny_obchodni_podil", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<Jmeni> uvolnenyObchodniPodil;
    @XmlElement(name = "Akcie", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Akcie akcie;
    @XmlElement(name = "Urceny_majetek", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<Texty> urcenyMajetek;
    @XmlElement(name = "Nadacni_majetek", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
