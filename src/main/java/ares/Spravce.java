...
/**
 * Specifick daje o sprvci konkurzu + zprotn sprvce konkurzu
 * 
...
public class Spravce {
    ...
    @XmlElement(name = "Spravce", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
