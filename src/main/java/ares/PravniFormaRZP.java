...
/**
 * Prvn forma vetn popisnch poloek
 * 
...
public class PravniFormaRZP {
    ...
    @XmlElement(name = "Zkraceny_nazev_PF", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected String zkracenyNazevPF;
    @XmlElement(name = "PF_osoba", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    @XmlSchemaType(name = "string")
    protected PfOsoba pfOsoba;
    @XmlElement(name = "TZU_osoba", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    @XmlSchemaType(name = "string")
