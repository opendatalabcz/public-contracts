...
/**
 * Nadan fond, k 16.6.2003 se jet nevyskytuje
 * 
...
public class NadacniFond {
    ...
    @XmlElement(name = "Opravnena_osoba_nadacniho_fondu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
