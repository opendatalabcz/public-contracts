...
public class Cinnosti {
    ...
    @XmlElement(name = "Predmet_podnikani", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<Texty> predmetPodnikani;
    @XmlElement(name = "Doplnkova_cinnost", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<Texty> doplnkovaCinnost;
    @XmlElement(name = "Predmet_cinnosti", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<Texty> predmetCinnosti;
    @XmlElement(name = "Predmet_cinn_pod", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<Texty> predmetCinnPod;
    @XmlElement(name = "Ucel_nadace", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<Texty> ucelNadace;
    @XmlElement(name = "Ucel_nad_fondu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
