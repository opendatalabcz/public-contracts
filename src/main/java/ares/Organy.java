...
/**
 * Orgny jsou angazma rozsirene o dic, stat, pr.formu, fyz.osobu v pravnicke, rodn prijmeni a rc cizince
 * 
...
public class Organy {
    ...
    @XmlElement(name = "Organ", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
