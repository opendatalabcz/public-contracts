...
/**
 * OKE - odvtvov klasifikace ekonomickch innost (slou pro dv rzn voln - 1. seznam oke bez nzvu, 2. jeden oke s nzvem
 * 
...
public class Okec {
    ...
    @XmlElement(name = "OKEC", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
    protected List<KodOkec> okec;
    @XmlElement(name = "Nazev_OKEC", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
