...
public class Akcie {
    ...
    @XmlElement(name = "Emise", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
    protected List<Emise> emise;
     ...
     *
     */
    public List<Emise> getEmise() {
        if (emise == null) {
            emise = new ArrayList<Emise>();
        }
        return this.emise;
    }
