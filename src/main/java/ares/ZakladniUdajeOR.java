...
/**
 * Zkladn identifikan a alokan daje ekonomickho subjektu
 * 
...
public class ZakladniUdajeOR {
    ...
    @XmlElement(name = "Platnost_od", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar platnostOd;
    @XmlElement(name = "Klic_ARES", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Integer klicARES;
    @XmlElement(name = "Stav", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", required = true)
    protected Stav stav;
    ...
    @XmlElement(name = "Cizi_nazev", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<CiziNazev> ciziNazev;
    @XmlElement(name = "Pravni_forma_OR", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<PravniForma> pravniFormaOR;
    @XmlElement(name = "PF_zakladatele", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    ...
    @XmlElement(name = "Misto_podnikani", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<AdresaARES> mistoPodnikani;
    @XmlElement(name = "Adresa_v_CR", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<AdresaARES> adresaVCR;
    @XmlElement(name = "Adresa_nadace", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<AdresaARES> adresaNadace;
    @XmlElement(name = "Adresa_nadacniho_fondu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<AdresaARES> adresaNadacnihoFondu;
    @XmlElement(name = "Bydliste", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<AdresaARES> bydliste;
    @XmlElement(name = "Umisteni_v_CR", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<AdresaARES> umisteniVCR;
    @XmlElement(name = "Adresa", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<AdresaARES> adresa;
    @XmlElement(name = "Fyzicka_osoba_OR", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected List<FyzickaOsoba> fyzickaOsobaOR;
    @XmlElement(name = "Financni_urad", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected FinancniUrad financniUrad;
    @XmlElement(name = "Datum_vzniku_OR", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar datumVznikuOR;
    @XmlElement(name = "Datum_zapisu_OR", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar datumZapisuOR;
    @XmlElement(name = "Datum_zaniku", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar datumZaniku;
    @XmlElement(name = "Fuze", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
    protected Short fuze;
    @XmlElement(name = "Udalosti", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2")
